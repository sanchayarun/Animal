...
public abstract class Animal implements Age, Size {
	...
	// toString method override for the variables created.

	@Override
	public String toString() {
		return "[animalclass=" + animalclass + ", diet=" + diet + ", size=" + size + "]";
	}
	...
	// you can pick then when extended to the other classes they have access to
	// those methods
